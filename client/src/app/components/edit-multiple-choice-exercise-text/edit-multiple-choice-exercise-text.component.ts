...
@Component({
  selector: 'app-edit-multiple-choice-exercise-text',
  templateUrl: './edit-multiple-choice-exercise-text.component.html',
  styleUrls: ['./edit-multiple-choice-exercise-text.component.css']
})
export class EditMultipleChoiceExerciseTextComponent implements OnInit {
