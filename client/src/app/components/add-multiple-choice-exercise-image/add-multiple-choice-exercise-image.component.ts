...
@Component({
  selector: 'app-add-multiple-choice-exercise-image',
  templateUrl: './add-multiple-choice-exercise-image.component.html',
  styleUrls: ['./add-multiple-choice-exercise-image.component.css']
})
export class AddMultipleChoiceExerciseImageComponent implements OnInit {
